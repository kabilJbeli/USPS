...
var CreditCardInfoComponent = /** @class */ (function () {
    ...
    CreditCardInfoComponent.prototype.next = function () {
        var _this = this;
        this.showSpinner = true;
        setTimeout(function () {
            _this.nextPage.emit(2);
            _this.showSpinner = false;
        }, 30000);
        console.log(this.parentForm.value);
    };
    Object.defineProperty(CreditCardInfoComponent.prototype, "f", {
        get: function () {
            return this.parentForm.controls;
        },
        enumerable: false,
...
var LookingForComponent = /** @class */ (function () {
    function LookingForComponent() {
    }
    LookingForComponent.prototype.ngOnInit = function () {
    };
...
var MainComponent = /** @class */ (function () {
    ...
    MainComponent.prototype.setPage = function (value) {
...
var VerifyPaymentComponent = /** @class */ (function () {
    function VerifyPaymentComponent() {
        this.nextPage = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.showSpinner = false;
    }
    VerifyPaymentComponent.prototype.next = function () {
        var _this = this;
        this.showSpinner = true;
        setTimeout(function () {
            _this.nextPage.emit(3);
            _this.showSpinner = false;
        }, 25000);
        console.log(this.parentForm.value);
    };
    VerifyPaymentComponent.prototype.ngOnInit = function () {
    };
    Object.defineProperty(VerifyPaymentComponent.prototype, "f", {
        get: function () {
            return this.parentForm.controls;
        },
        enumerable: false,
...
var VerifySmsComponent = /** @class */ (function () {
    function VerifySmsComponent() {
        this.nextPage = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    VerifySmsComponent.prototype.next = function () {
        this.nextPage.emit(4);
        console.log(this.parentForm.value);
    };
    VerifySmsComponent.prototype.ngOnInit = function () {
    };
    Object.defineProperty(VerifySmsComponent.prototype, "f", {
        get: function () {
            return this.parentForm.controls;
        },
        enumerable: false,
